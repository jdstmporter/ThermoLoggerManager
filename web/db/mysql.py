...
class SQLStore:
    ...
    def __init__(self,params):
        syslog(LogLevel.INFO,f'Connecting to mysql')
        syslog(LogLevel.INFO,f'DB = {params.db_database} HOST = {params.db_host} USER = {params.db_user} PASSWORD = {params.db_password} PORT = {params.db_port}')
